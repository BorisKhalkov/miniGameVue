		...
		let app = new Vue({
			...
			methods: {
				...
				endGame() {
					...
					//Taldarim
					else if (this.score.protos > this.score.protoss && this.score.protos > this.score.terran && this.score.taldarim == 5) {
			...
			computed: {
				...
				showResultRace() {
					return {
						...
						'zergprotos': this.totalGame.zergprotos > 0 ? true : false,
